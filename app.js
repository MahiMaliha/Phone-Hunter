        ...
        if (phoneData.length !== 0 && searchValue !== '') {
            ...
            for (let index in phoneData) {
                ...
                if (index <= cardslimit) {
                    ...
                    // display phone card  
                    const phoneItem = `<div class="card text-center p-5 shadow  mb-5 bg-body rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="#" id ="loadDetails" class="btn btn-secondary px-5 pe-5" onclick="selectedPhoneDetails('${phone.slug}')">Details</a>
                                            </div>
                                          </div>
                                          `
